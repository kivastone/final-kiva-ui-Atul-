<template>
  <div class="container-fluid levante-container">
    <div class="row">
        ...
        <div class="intro">
          ...
          <div class="container-fluid">
            <div
              ...
              data-aos-once="true"
            >
              <div class="nav-small-text col-12 text-center">
                OUR EXQUISITE QUARTZ COLLECTION
              </div>
  ...
  created() {
    fetch(apiEndpoint + "auth/login/token/", {
      ...
      .then((data) => {
        ...
        fetch(apiEndpoint + "inventory/stone/v1?category_code=Quartz", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
.header-logo {
  width: 100%;
  background-image: url("../../static/lav.png");
