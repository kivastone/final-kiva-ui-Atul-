  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12 px-0">
        ...
        <div class="nav-experience-text">MARBLES</div>
          ...
          <div class="col-lg-9 col-md-12">
            <div class="row">
              ...
              <div v-else v-for="tile in tileList" class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <InventoryTile :id="tile.item_code" :category_code="tile.category_code" :tileCode="tile.item_code"
                  :tileName="tile.title" :imageUrl="tile.slab_images" />
              </div>
            </div>
            <!-- <div class="row mt-5">
  ...
  created() {
    fetch(apiEndpoint + 'auth/login/token/', {
      ...
      .then((data) => {
        ...
        fetch(apiEndpoint + 'inventory/stone/v1?category_code=Marbles', {
          method: "GET",
          headers: {
            'Content-Type': 'application/json',
...
.header-logo {
  width: 100%;
  background-image: url("../../static/marble.png");
