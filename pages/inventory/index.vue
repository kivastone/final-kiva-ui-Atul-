    ...
    <div class="row">
      <div class="col-12 px-0">
        <Banner
          ...
          banner="inventory.png"
        />
        <!-- <NavBar />
        <div class="nav-small-text">OUR EXQUISITE</div>
        <div class="nav-experience-text">SELECTION</div>
  ...
  created() {
    fetch(apiEndpoint + "auth/login/token/", {
      ...
      .then((data) => {
        ...
        fetch(apiEndpoint + "inventory/stone/v1", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
.header-logo {
  width: 100%;
  background-image: url("../../static/inventory.png");
